...
def repo_squash(repository: Optional[str] = None, public_repository: Optional[str] = None,
    ...
    """Super-squash the configured Yande.re dataset repositories when history grows too large."""
...
if __name__ == '__main__':
    run_callable_from_cli(repo_squash, defaults={
        'repository': env_default('REMOTE_REPOSITORY_YR', default=None),
        'public_repository': env_default('REMOTE_REPOSITORY_YR_PUBLIC', default=None),
        'public_repository_4m': env_default('REMOTE_REPOSITORY_YR_PUBLIC_4M', default=None),
    })
