...
@click.command(
    ...
    help='Super-squash the configured Yande.re dataset repositories when history grows too large. '
...
@click.option(
    '-p', '--public-repository',
    type=str,
    envvar='REMOTE_REPOSITORY_YR_PUBLIC',
    default=None,
    show_envvar=True,
...
@click.option(
    ...
    type=str,
    envvar='REMOTE_REPOSITORY_YR_PUBLIC_4M',
    default=None,
    show_envvar=True,
