...
def sync(repository: str):
    ...
    while True:
        ...
        try:
            _ = srequest(session, 'GET', 'https://yande.re/tag.json')
    ...
    resp = srequest(session, 'GET', 'https://yande.re/tag.json', params={'limit': '0'})
    ...
    while True:
        resp = srequest(session, 'GET', 'https://yande.re/tag_alias.json', params={'page': str(page)})
...
@click.command(
    ...
    help='Sync Yande.re tag and alias metadata into the target Hugging Face dataset repository. '
