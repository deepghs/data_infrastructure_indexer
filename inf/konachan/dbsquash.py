...
if __name__ == '__main__':
    run_callable_from_cli(repo_squash, defaults={
        'repository': env_default('REMOTE_REPOSITORY_KN', default=None),
        'public_repository': env_default('REMOTE_REPOSITORY_KN_PUBLIC', default=None),
        'public_repository_4m': env_default('REMOTE_REPOSITORY_KN_PUBLIC_4M', default=None),
    })
