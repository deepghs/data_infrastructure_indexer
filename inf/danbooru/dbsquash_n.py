...
@click.command(
    ...
    help='Super-squash the configured Danbooru dataset repositories when history grows too large. '
...
@click.option(
    '-p', '--public-repository',
    type=str,
    envvar='REMOTE_REPOSITORY_DB_N_PUBLIC',
    default=None,
    show_envvar=True,
...
@click.option(
    ...
    type=str,
    envvar='REMOTE_REPOSITORY_DB_N_PUBLIC_4M',
    default=None,
    show_envvar=True,
